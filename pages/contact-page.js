    ...
    <Layout title="Contact">
      <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs mt-2 text-gray-600">Yokohama</p>
          <p className="font-bold mt-3">E-mail</p>
          <p className="text-xs mt-2 text-gray-600">cha-yu@gmail.com</p>
        ...
        <div className="mt-6 flex justify-around">
          <div>
            <a
              href="https://twitter.com/cha_ayu418"
              target="_blank"
          ...
          <div>
            <a
              href="https://github.com/ayumin418"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
